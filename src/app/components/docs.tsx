                    ...
                    <div key={q.id} className="shadow-md shadow-indigo-200 flex flex-col items-center justify-center gap-4 min-h-64 max-w-96 bg-yellow-400  p-5 rounded-md mb-8 ">
                        ...
                        <div className="flex items-center justify-between">
                            <form className="flex flex-col items-center" action={update}>
                                <input className="placeholder-slate-300 w-60 bg-indigo-400 hover:bg-indigo-500 active:bg-indigo-600 text-xl text-indigo-950 rounded-full px-1 py-1 transition-colors duration-300 ease-in-out" type="author" name="author" defaultValue={q.author} placeholder={"Author " + q.id} />
                                <input className="placeholder-slate-300 w-60 bg-indigo-400 hover:bg-indigo-500 active:bg-indigo-600 text-xl text-indigo-950 rounded-full px-1 py-1 transition-colors duration-300 ease-in-out" type="quote" name="quote" defaultValue={q.quote} placeholder={"quote " + q.id} />
